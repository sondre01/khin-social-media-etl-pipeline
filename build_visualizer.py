    ...
    <div class="p-6 md:p-8 rounded-2xl bg-gradient-to-br from-gray-900/90 via-blue-950/20 to-gray-900/90 border border-blue-500/15 relative overflow-hidden">
      ...
      <div class="relative z-10 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
        <div class="max-w-3xl space-y-3">
          <div class="inline-flex items-center space-x-2 px-3 py-1 rounded-full bg-cyan-500/10 border border-cyan-500/20 text-cyan-300 text-xs font-medium">
            <i data-lucide="zap" class="w-3.5 h-3.5"></i>
            <span>Interactive Data Engineering Visualization Platform</span>
          </div>
