...
<body class="min-h-screen flex flex-col selection:bg-cyan-500/30 selection:text-cyan-200">
  ...
  <header class="sticky top-0 z-50 glass-card border-b border-gray-800/80 px-4 lg:px-8 py-3.5">
    <div class="max-w-7xl mx-auto flex flex-wrap items-center justify-between gap-4">
      ...
      <!-- Nav Bar with Shifted Role Pills on Left Side -->
      <div class="hidden md:flex items-center space-x-2.5">
        ...
        <div class="flex items-center space-x-1.5 bg-gray-900/80 p-1 rounded-xl border border-gray-800 text-xs">
          ...
          <span class="px-2.5 py-1 rounded-lg bg-cyan-500/10 text-cyan-400 border border-cyan-500/20 font-medium flex items-center space-x-1">
        ...
        <!-- Quick Nav Tabs -->
        <nav class="flex items-center space-x-1 bg-gray-900/70 p-1 rounded-xl border border-gray-800">
